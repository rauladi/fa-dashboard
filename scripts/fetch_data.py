...
# ---------- DEEP STATIC PROFILES (abbreviated – use your existing ones) ----------
PROFILES = {
    # ... (include your full PROFILES dictionary here) ...
}

LEADERSHIP = {
    # ... (include your full LEADERSHIP dictionary here) ...
}
